...
export function OrderHistory() {
  ...
  return (
    <AuthenticatedLayout showNavbar={true}>
      <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-primary/5 p-2 sm:p-4 md:p-6 space-y-6">
        {/* Summary Stats */}
                    ...
                    <CardContent className="p-4 md:p-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-primary">{formatIDR(order.total_price)}</p>
                        </div>
                        <div>
                          <p className="text-sm text-muted-foreground">Savings</p>
                          <p className="font-medium text-green-600">{formatIDR(calculateSavings(order))}</p>
                        </div>
                      </div>
