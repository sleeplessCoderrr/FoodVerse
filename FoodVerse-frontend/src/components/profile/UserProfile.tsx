...
import { User, Mail, Phone, MapPin, Calendar, Shield, Edit, Save, X, Lock, TrendingUp, ShoppingBag, Star } from 'lucide-react'
...
export function UserProfile() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-primary/5 py-8 px-2 sm:px-4 relative overflow-hidden">
      {/* Animated background blobs */}
      <div className="absolute top-0 left-0 w-72 h-72 bg-primary/10 rounded-full blur-3xl animate-pulse -z-10" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-secondary/20 rounded-full blur-3xl animate-pulse -z-10" />
      <div className="max-w-4xl w-full mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6 mb-8">
          <div className="flex-shrink-0">
            <div className="w-24 h-24 rounded-full bg-muted/50 border-4 border-primary flex items-center justify-center overflow-hidden shadow-lg">
              {/* Avatar fallback: just use User icon, as user.avatar_url is not available */}
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-muted-foreground text-sm">Member since {formatDate(user.created_at)}</span>
            </div>
              ...
              <CardContent className="p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold">{formatIDR(stats.total_savings)}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        {/* Seller Request Button (if not seller) */}
        {user.user_type === 'consumer' && (
          <div className="mb-8 flex justify-center">
            <Button
              variant="secondary"
              size="lg"
              className="px-8 py-4 text-lg font-semibold shadow-md hover:scale-105 transition-transform"
