    ...
    <div className="space-y-6">
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {stores.map((store) => (
                <Card key={store.id} className={`cursor-pointer transition-all ${selectedStore?.id === store.id ? 'ring-2 ring-primary' : ''}`}>
      ...
      {selectedStore && (
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              <CardTitle>Food Bags - {selectedStore.name}</CardTitle>
              <CardDescription>Manage food offerings for this store</CardDescription>
            </div>
                  ...
                  <Card key={foodBag.id}>
                    <CardContent className="p-4">
                      ...
                      <div className="space-y-2">
                        <div>
                          <h3 className="font-semibold">{foodBag.title}</h3>
